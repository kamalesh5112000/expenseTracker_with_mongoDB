...
async function display(){
    ...
    const res = await axios.get('http://3.88.203.108:443/analysis',{headers:{"Authorization":token}});
    const fres= await axios.get('http://3.88.203.108:443/filesdownloaded',{headers:{"Authorization":token}});
...
async function downloadfile(){
    const token = localStorage.getItem('token');
    const res = await axios.get('http://3.88.203.108:443/download',{headers:{"Authorization":token}});
